module MsgPack_RPC_Interface::VHDL::Signal::Integer::Query
  extend MsgPack_RPC_Interface::VHDL::Util

  def generate_decl(indent, name, type, kvmap, registory)
    return MsgPack_RPC_Interface::VHDL::Register::Integer::Query.generate_decl(indent, name, type, kvmap, registory)
  end

  def generate_stmt(indent, name, type, kvmap, registory)
    return MsgPack_RPC_Interface::VHDL::Register::Integer::Query.generate_stmt(indent, name, type, kvmap, registory)
  end
  ...
  def use_package_list(kvmap)
    return MsgPack_RPC_Interface::VHDL::Register::Integer::Query.use_package_list(kvmap)
  end
